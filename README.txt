Comandos básicos Git:
	...
	- git checkout <nombre-de-la-rama> --> Moverse a la rama
	- git log --> Ver o histórico  
	- git status --> Información sobre la rama
	- git add --> Incluir cambios a rama
	- git add -A --> Actualizar todos os cambios a vez 
